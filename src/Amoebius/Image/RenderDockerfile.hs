...
renderDockerfile catalog = do
    ...
    pure . Dockerfile . Text.unlines $
        ...
        , "# GENERATED BY Amoebius.Image.RenderDockerfile FROM Amoebius.Image.CanonicalBakeCatalog; DO NOT EDIT"
        , "ARG BASE_IMAGE"
        ]
            ...
            <> [ renderBaseFrom
               ...
               , "LABEL io.amoebius.bake-catalog=\"Amoebius.Image.CanonicalBakeCatalog\""
               ]
  ...
  where
    ...
    renderPayload payload =
        renderPublished
            ...
            payload.checksumShape
            payload.archiveFormat
    ...
    extract format member target = case (format, Text.null member) of
        ...
        (TarGz, True) ->
            "mkdir -p "
                <> target
                <> " && tar -xzf /tmp/asset --strip-components=1 -C "
                <> target
                <> " \\"
        (TarGz, False) ->
