...
-- | The finding vocabulary of the standalone documentation checker. A finding is a
-- code, a subject path, and a detail; a check result is a named list of findings and
-- observations. The runner reads the rendered ledger, never these types.

module Amoebius.Doc.Types
  ( CheckResult (..)
  , Finding (..)
  , Observation (..)
  , checkPassed
