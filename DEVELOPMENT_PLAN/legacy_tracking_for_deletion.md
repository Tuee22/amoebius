...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/README.md, DEVELOPMENT_PLAN/overview.md, DEVELOPMENT_PLAN/phase_13_midwife_bootstrap_kind.md, documents/engineering/lift_and_compose_doctrine.md, documents/engineering/substrate_doctrine.md
...
- **Why two phases on the transport rows.** The native `amoebius-pulsar` client lands in
  [Phase 22](phase_22_pulsar_client.md), but the sibling transports are only *deleted* when
  each library is migrated onto it — infernix's WebSocket gateway at [Phase 26](phase_26_infernix_lift.md)
  and jitML's Node-subprocess client at [Phase 27](phase_27_jitml_lift_cuda.md), one subsystem at a time
...
- **The substrate-equivalence row is a standing prohibition, not a one-time deletion.** "Per-substrate
  ...
  enforcing build-time check is itself a [Phase 18](phase_18_platform_services.md) deliverable,
...
- [phase_18_platform_services.md](phase_18_platform_services.md) — owns the no-Helm platform render, the baked operators, `distribution`, multi-arch, and the substrate-equivalence check
- [phase_22_pulsar_client.md](phase_22_pulsar_client.md) — owns the native `amoebius-pulsar` client that retires the WebSocket transports
