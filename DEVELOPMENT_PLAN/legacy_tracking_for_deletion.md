...
**Supersedes**: N/A
**Referenced by**: README.md, overview.md, phase_13_midwife_bootstrap_kind.md
...
| **jitML** as a standalone product | sibling `jitML/` — `JitML.*` | jitML becomes an **ML extension library** whose single-writer trainer fails over via a **Pulsar Exclusive/Failover subscription + content-store CAS** (no bespoke election), not a separate product | [Phase 27](phase_27_jitml_lift_cuda.md) |
