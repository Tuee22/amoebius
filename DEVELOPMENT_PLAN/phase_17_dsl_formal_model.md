# Phase 17: DSL formal model

> **Purpose**: Point the Phase-3 model kernel at amoebius's own DSL — the decoder, the folds, `renderAll`,
...
Phase 17 delivers the DSL formal model; its design is owned by [formal_model_doctrine.md](../documents/engineering/formal_model_doctrine.md), [dsl_doctrine.md](../documents/engineering/dsl_doctrine.md), and the plan for reaching it is owned here.
...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/README.md, DEVELOPMENT_PLAN/legacy_tracking_for_deletion.md, DEVELOPMENT_PLAN/overview.md, DEVELOPMENT_PLAN/phase_18_reconcile_core_simulation.md, DEVELOPMENT_PLAN/system_components.md
...
- [Sprints](#sprints)
- [Sprint 17.1: Refinement models for the decoder, the folds, and `renderAll` 📋](#sprint-171-refinement-models-for-the-decoder-the-folds-and-renderall-)
- [Sprint 17.2: The `chain`/`Step` descent 📋](#sprint-172-the-chainstep-descent-)
- [Sprint 17.3: The concurrent protocols 📋](#sprint-173-the-concurrent-protocols-)
- [Sprint 17.4: The reconcile invariants 📋](#sprint-174-the-reconcile-invariants-)
...
Phase 3 builds a model kernel and proves it on a throwaway two-process reference model. Phase 4 expresses the
...
moment a claim needs the real code running, it belongs to [Phase 18](phase_18_reconcile_core_simulation.md).
...
Phase 18 does not open unless the ledger records Register 1 green and marks model↔code correspondence for the
*effectful* daemon UNVERIFIED, which [Phase 18](phase_18_reconcile_core_simulation.md) and the live band own.

## Gate integrity

Every model is emitted by the Phase-3 kernel (`interpret` / `emitTLA` render one value, so there is no
...
## Sprint 17.1: Refinement models for the decoder, the folds, and `renderAll` 📋
...
### Deliverables
- One specification per surface, emitted by the Phase-3 kernel.
...
## Sprint 17.2: The `chain`/`Step` descent 📋
...
## Sprint 17.3: The concurrent protocols 📋
...
## Sprint 17.4: The reconcile invariants 📋

**Status**: Planned
**Implementation**: `src/Amoebius/Formal/Dsl/Reconcile.hs`
**Blocked by**: Sprint 17.3
...
3. No claim in this phase's ledger asserts anything about the *effectful* daemon, which
   [Phase 18](phase_18_reconcile_core_simulation.md) and the live band own.
...
- `formal_model_doctrine.md` — the obligation set widens from one to the set this phase states (Sprint 17.1).
- `gateway_migration_model_doctrine.md` — the cross-cluster migration remains *an* obligation, no longer *the*
  obligation (Sprint 17.1).
- `dsl_doctrine.md` — the descent's modelled properties (Sprint 17.2).
- `cluster_lifecycle_doctrine.md` — its reconcile-loop proof claim moves from sibling evidence to this phase (Sprint 17.4).

**Cross-references to add:**
- `DEVELOPMENT_PLAN/README.md` Phase Overview links its Phase 17 row to this document.

## Related Documents

- [README.md](README.md) — the live tracker; its Phase 17 row is the source for this phase's objective and gate.
- [development_plan_standards.md](development_plan_standards.md) — the rulebook this document obeys.
- [phase_18_reconcile_core_simulation.md](phase_18_reconcile_core_simulation.md) — the Register-2 half; what a
