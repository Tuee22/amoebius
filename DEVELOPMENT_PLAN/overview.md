...
- **Phase 27 — jitML lift + checkpoints + CUDA** (`linux-cuda`) → [phase_27](phase_27_jitml_lift_cuda.md): a jitML run is bit-deterministic; the trainer fails over via a Pulsar Exclusive/Failover subscription (no election).
