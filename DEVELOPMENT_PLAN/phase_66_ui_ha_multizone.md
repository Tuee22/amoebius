# Phase 66: Initial online UI multi-zone high availability
...
- [Sprints](#sprints)
- [Sprint 66.1: Run the multi-zone UI failure campaign ⏸️](#sprint-661-run-the-multi-zone-ui-failure-campaign-)
...
online HA gate. Offline outbox/blob continuity is not claimed until Phase 69.
...
## Sprint 66.1: Run the multi-zone UI failure campaign ⏸️
...
- [Phase 65 — UI rollout and reconnect](phase_65_ui_rollout_reconnect.md)
