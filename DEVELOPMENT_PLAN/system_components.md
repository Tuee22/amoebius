...
| CLI context — `Command` ADT, `--help`, reconcile triggers, status | [daemon_topology §1](../documents/engineering/daemon_topology_doctrine.md#1-one-binary-three-contexts) | `src/Amoebius/Cli.hs` (PLANNED) | [phase_14_chain_kernel_boundary.md](phase_14_chain_kernel_boundary.md) |
...
| LoadBalancer (MetalLB-or-cloud, the one substrate-driven difference) | [platform_services §9 — The LoadBalancer and the single wild-ingress path](../documents/engineering/platform_services_doctrine.md#9-the-loadbalancer-and-the-single-wild-ingress-path) | `src/Amoebius/Platform/LoadBalancer.hs` (PLANNED) | [phase_30_platform_backbone.md](phase_30_platform_backbone.md) |
...
| Pure peer-config render (`render(nodeInventory) -> [WireGuardPeerConfig]`; keyless/overlapping-IP foreclosed) | [network_fabric [§3](#3-manifests--typed-renderer--the-ssa-reconciler)/[§4](#4-capabilities--the-capabilityprovidershape-binder)](../documents/engineering/network_fabric_doctrine.md#4-topology-the-hub-is-the-gateway-role-and-the-fabric-moves-with-it) | `src/Amoebius/Fabric/WgRender.hs` (PLANNED) | [phase_41_network_fabric_wireguard.md](phase_41_network_fabric_wireguard.md) |
| WireGuard reconcile (`wg show → diff → wg set`, singleton-driven, `wg0`-bound listeners) | [network_fabric [§3](#3-manifests--typed-renderer--the-ssa-reconciler)/[§5](#5-platform-services--baked-binaries--the-distribution-registry)](../documents/engineering/network_fabric_doctrine.md#5-the-security-boundary-generalizes-localhost--authenticated-fabric) | `src/Amoebius/Fabric/WgReconcile.hs` (PLANNED) | [phase_41_network_fabric_wireguard.md](phase_41_network_fabric_wireguard.md) |
...
| Gateway-migration runtime (both branches) + client rebind/DNS repoint + model-correspondence | [gateway_migration [§2](#2-the-dsl--dhall-decoder--chainstep-kernel)/[§3](#3-manifests--typed-renderer--the-ssa-reconciler)/[§4](#4-capabilities--the-capabilityprovidershape-binder)/[§5](#5-platform-services--baked-binaries--the-distribution-registry)](../documents/engineering/gateway_migration_doctrine.md#5-the-migration-as-a-typed-edge-observed-state-machine) | `src/Amoebius/Multicluster/{GatewayMigration,PlannedHandover,ClientRebind,DnsRepoint,PromotionGate}.hs`, `src/Amoebius/Formal/GatewayMigration.hs` (PLANNED) | [phase_43_gateway_migration_drills.md](phase_43_gateway_migration_drills.md) |
...
| Pure whole-deployment `renderAll` + rendered-output goldens (exact checked resource projection / hardened context / derived NetworkPolicy / no backdoor ingress) | [manifest_generation [§2](#2-the-dsl--dhall-decoder--chainstep-kernel)/[§3](#3-manifests--typed-renderer--the-ssa-reconciler)](../documents/engineering/manifest_generation_doctrine.md) | `src/Amoebius/Manifest/{Types,Render,RenderAll}.hs` (the rendered manifests are generated, not committed) | [phase_13](phase_13_render_manifest_goldens.md) |
