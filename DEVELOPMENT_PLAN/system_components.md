...
| Host Bootstrap Coordinator | The source module, imports, test, error type, commands, and generated-label contract are renamed in the dirty worktree without a compatibility alias | Retain the zero-result terminology scan and rerun the migrated Phase-24 gate after its generated-output path is current | Phase 24 |
