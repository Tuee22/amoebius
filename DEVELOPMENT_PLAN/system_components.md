...
| Bootstrap sequence + host→singleton handoff + admin control-plane REST (`vault init/unseal`, `dhall update`, secret `kv put/get/list/delete`) | [bootstrap_sequence_doctrine](../documents/engineering/bootstrap_sequence_doctrine.md) | `src/Amoebius/Cluster/BringUp.hs`, `src/Amoebius/ControlPlane/AdminApi.hs` (PLANNED; sequence+handoff Phase 17, admin REST + KV-CRUD Phase 26) | [phase_17_midwife_bootstrap_kind.md](phase_17_midwife_bootstrap_kind.md) |
