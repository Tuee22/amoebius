...
| Generated support-material boundary | `src/tool-and-mutant-generation/Amoebius/Generate/CheckingCorpus.hs`; independent Haskell oracle/spec; package-hidden Phase-47 supervisor | [JIT Artifact Doctrine](../documents/engineering/jit_artifact_doctrine.md), [Testing Doctrine §9](../documents/engineering/testing_doctrine.md#9-derivation-generated-enumeration-authored-expectation) | [47](phase_47_tool_and_mutant_generation.md) |
| Pure test-workflow decision algebra | `src/test-workflow-algebra/Amoebius/Test/WorkflowAlgebra.hs`; independent Haskell oracle/spec and compiler witnesses; package-hidden Phase-48 supervisor | [Testing Doctrine](../documents/engineering/testing_doctrine.md) | [48](phase_48_test_workflow_algebra.md) |
| Hardware-free self-referential gate barrier | `src/self-referential-gates/**`; Haskell oracle/spec and package-hidden supervisor | [Testing Doctrine](../documents/engineering/testing_doctrine.md) | [49](phase_49_self_referential_gates.md) |
