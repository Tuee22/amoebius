...
| 17 | No-provisioner retained storage + lossless rebind | `linux-cpu` | Retained PVs that rebind across delete/recreate; MetalLB is the bare-metal/kind LB ([`substrate_doctrine.md` §7](../documents/engineering/substrate_doctrine.md#7-the-loadbalancer-is-the-one-substrate-driven-platform-difference)). No GPU axis. |
