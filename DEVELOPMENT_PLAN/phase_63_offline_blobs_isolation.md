# Phase 63: Offline blobs and partition isolation
...
Phase 63 delivers the offline blobs and partition isolation; its design is owned by [browser_offline_runtime_doctrine.md](../documents/engineering/browser_offline_runtime_doctrine.md), [tenancy_doctrine.md](../documents/engineering/tenancy_doctrine.md), [resource_capacity_doctrine.md](../documents/engineering/resource_capacity_doctrine.md), and the plan for reaching it is owned here.
...
- [Sprints](#sprints)
- [Sprint 63.1: Gate encrypted blob replay and isolation ⏸️](#sprint-631-gate-encrypted-blob-replay-and-isolation-)
...
## Sprint 63.1: Gate encrypted blob replay and isolation ⏸️
