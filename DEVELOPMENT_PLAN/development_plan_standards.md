...
| `host-floor` | The per-substrate floor of [`substrate_doctrine.md` §3.1](../documents/engineering/substrate_doctrine.md#31-the-per-substrate-floor-what-only-the-operator-can-supply) — the package-manager root, a hardware or firmware fact, and nothing else. Named here, defined there | Phases 1, 2, 50, 51, 52, 53, 54, 25, 26, 93, 57 |
