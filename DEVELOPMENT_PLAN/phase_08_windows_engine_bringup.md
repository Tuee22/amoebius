# Phase 8: Windows: WSL2 and the lifted Linux engine
...
the frame exists — that is Phase 6's, and this phase evaluates it rather than restating it — nor the mount
...
fixes once for every substrate. Its one prerequisite is [Phase 7](phase_07_apple_engine_bringup.md), which
...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/README.md, DEVELOPMENT_PLAN/development_plan_phase_model.md, DEVELOPMENT_PLAN/substrates.md
...
- [Sprints](#sprints)
- [Sprint 8.1: The firmware and elevation preflight 📋](#sprint-81-the-firmware-and-elevation-preflight-)
- [Sprint 8.2: Ensuring WSL2 through the vendor installer 📋](#sprint-82-ensuring-wsl2-through-the-vendor-installer-)
- [Sprint 8.3: The reboot verdict and the convergent retry 📋](#sprint-83-the-reboot-verdict-and-the-convergent-retry-)
- [Sprint 8.4: The amoebius-owned distro 📋](#sprint-84-the-amoebius-owned-distro-)
- [Sprint 8.5: The lifted Linux plan 📋](#sprint-85-the-lifted-linux-plan-)
...
it, and the Linux plan Phase 6 proved is evaluated inside that distro without amendment.
...
than aspirational: the step sequence evaluated inside the distro is compared against the sequence Phase 6
...
**Depends on**: [Phase 7](phase_07_apple_engine_bringup.md)
...
checks. The distro-side step sequence is then joined against the sequence Phase 6's gate recorded, in both
...
## Sprint 8.1: The firmware and elevation preflight 📋
...
## Sprint 8.2: Ensuring WSL2 through the vendor installer 📋
...
## Sprint 8.3: The reboot verdict and the convergent retry 📋
...
## Sprint 8.4: The amoebius-owned distro 📋
...
## Sprint 8.5: The lifted Linux plan 📋

**Status**: Planned
**Implementation**: `src/Amoebius/Substrate/Windows/Lift.hs`, `test/oracle/windows_engine_bringup_route.tsv`
**Blocked by**: Sprint 8.4
**Independent Validation**: the distro-side step sequence joins to the sequence Phase 6's gate recorded, in both directions
...
- [Phase 7](phase_07_apple_engine_bringup.md)
