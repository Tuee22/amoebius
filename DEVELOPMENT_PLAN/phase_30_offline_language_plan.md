# Phase 30: Offline language and paired plans
...
Phase 30 delivers the offline language and paired plans; its design is owned by [browser_offline_runtime_doctrine.md](../documents/engineering/browser_offline_runtime_doctrine.md), and the plan for reaching it is owned here.
...
- [Sprints](#sprints)
- [Sprint 30.1: Compile the offline contract ⏸️](#sprint-301-compile-the-offline-contract-)
...
## Sprint 30.1: Compile the offline contract ⏸️
