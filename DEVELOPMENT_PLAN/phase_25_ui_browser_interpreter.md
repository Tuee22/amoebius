# Phase 25: Generic browser interpreter
...
- [Sprints](#sprints)
- [Sprint 25.1: Generic `ClientPlan` interpreter and browser boundary gate ✅](#sprint-251-generic-clientplan-interpreter-and-browser-boundary-gate-)
...
`sha256:a70b1cd50e69733b…`; Phase 25 owns no remaining migration deferral.
...
server only as a boundary peer; server authorization semantics belong to Phase 26.
...
**Depends on:** Phase 23 — canonical immutable `ClientPlan` encoding and public contracts.
...
in [Gate integrity](#gate-integrity), emitting a Register-2 ledger whose live layers stay UNVERIFIED. Phase 27
...
- Phase 27 — consume this interpreter unchanged in the local composed application.

## Related Documents

- [Phase 23](phase_23_ui_plan_compiler.md) — the required immutable `ClientPlan` and public contracts.
