...
- [Sprints](#sprints)
- [Sprint 29.1: Deterministic paired-plan projection ✅](#sprint-291-deterministic-paired-plan-projection-)
...
`sha256:f6739fd9fd7f6fd2…`; Phase 29 owns no remaining migration deferral.
...
seeded mutants redden. Evidence and the ledger move into `.build/runs/phase_23/<run-id>/`, and 55 surfaces join
...
correctness or a live release. See the Phase-29 ledger.
...
**Depends on:** [Phase 28](phase_28_ui_effect_binding.md) — the sealed `BoundUiProgram` with complete effect bindings.
...
## Sprint 29.1: Deterministic paired-plan projection ✅
...
- Phases 31 and 32 — consume the paired artifacts independently; neither may recompile or reinterpret source.

## Related Documents

- [Phase 28](phase_28_ui_effect_binding.md) — the required sealed bound program.
