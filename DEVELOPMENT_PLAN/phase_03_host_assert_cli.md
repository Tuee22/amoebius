# Phase 3: The `pb` host-assertion CLI
...
[Phase 4](phase_04_host_ensure_kernel.md)'s and every later host action is the binary's, as
...
[Gate integrity](#gate-integrity). Phase 4 does not open until it is green.
