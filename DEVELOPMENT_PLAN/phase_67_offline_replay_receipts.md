# Phase 67: Offline replay and durable receipts
...
Phase 67 delivers the offline replay and durable receipts; its design is owned by [browser_offline_runtime_doctrine.md](../documents/engineering/browser_offline_runtime_doctrine.md), [ui_realtime_coordination_doctrine.md](../documents/engineering/ui_realtime_coordination_doctrine.md), [testing_doctrine.md](../documents/engineering/testing_doctrine.md), and the plan for reaching it is owned here.
...
- [Sprints](#sprints)
- [Sprint 67.1: Gate durable replay across replicas ⏸️](#sprint-671-gate-durable-replay-across-replicas-)
...
⏸️ Blocked pending Phase-66 revalidation — **reopened 2026-08-16 by the natural-architecture amendment.**
...
payload; offline blob transfer is deferred to Phase 68. Phase 30 structurally admits jitML training starts,
...
scoped command/work-id through Pulsar, Phase-49 receipt lookup, and ready-artifact outcome recovery.
...
## Sprint 67.1: Gate durable replay across replicas ⏸️
