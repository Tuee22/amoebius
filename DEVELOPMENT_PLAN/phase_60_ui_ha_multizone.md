# Phase 60: Initial online UI multi-zone high availability
...
**Supersedes**: DEVELOPMENT_PLAN/phase_48_spa_live_deploy.md (HA/failover portion)
...
- [Sprints](#sprints)
- [Sprint 60.1: Run the multi-zone UI failure campaign ⏸️](#sprint-601-run-the-multi-zone-ui-failure-campaign-)
...
online HA gate. Offline outbox/blob continuity is not claimed until Phase 63.
...
## Sprint 60.1: Run the multi-zone UI failure campaign ⏸️
...
- [Phase 59 — UI rollout and reconnect](phase_59_ui_rollout_reconnect.md)
