...
**Blocked by**: Sprint 24.2, Sprint 24.3.
...
- `documents/engineering/bootstrap_sequence_doctrine.md` — record that `pb`'s **midwife** mode is delivered here
  and that its **admin-REST client** mode (§5) is owned by [phase_33](phase_33_live_dsl_singleton.md)
...
- [Bootstrap Sequence Doctrine](../documents/engineering/bootstrap_sequence_doctrine.md) — the unified `pb` CLI's
  two modes (midwife here; admin-REST client in [phase_33](phase_33_live_dsl_singleton.md) Sprint 33.4).
