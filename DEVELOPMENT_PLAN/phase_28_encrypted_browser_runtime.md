# Phase 28: Encrypted browser offline runtime
...
Phase 28 delivers the encrypted browser offline runtime; its design is owned by [browser_offline_runtime_doctrine.md](../documents/engineering/browser_offline_runtime_doctrine.md), and the plan for reaching it is owned here.
...
- [Sprints](#sprints)
- [Sprint 28.1: Build the encrypted local interpreter ⏸️](#sprint-281-build-the-encrypted-local-interpreter-)
...
## Sprint 28.1: Build the encrypted local interpreter ⏸️
