...
**Blocked by**: Phase 14 gate (the boundary fake-tool harness — its single `Exec/Tool.hs` IO seam is the seam
this sprint generalizes into a typed effect interface); Phase 14 gate (the `chain :: cfg -> [Step]` plan the toy
