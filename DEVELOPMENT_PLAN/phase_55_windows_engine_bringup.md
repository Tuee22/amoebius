# Phase 55: Windows: WSL2 and the lifted Linux engine

> **Purpose**: Admit `windows` as a gated substrate — read the firmware fact before anything is installed,
> ensure WSL2, provision an amoebius-owned distro, and evaluate the independently approved Phase-53 Linux plan
...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/README.md, DEVELOPMENT_PLAN/overview.md, DEVELOPMENT_PLAN/phase_56_bootstrap_coordinator_kind.md, DEVELOPMENT_PLAN/substrates.md
...
- [Sprints](#sprints)
- [Sprint 55.1: The firmware and elevation preflight ⏸️](#sprint-551-the-firmware-and-elevation-preflight-)
- [Sprint 55.2: Ensuring WSL2 through the vendor installer ⏸️](#sprint-552-ensuring-wsl2-through-the-vendor-installer-)
- [Sprint 55.3: The reboot verdict and the convergent retry ⏸️](#sprint-553-the-reboot-verdict-and-the-convergent-retry-)
- [Sprint 55.4: The amoebius-owned distro ⏸️](#sprint-554-the-amoebius-owned-distro-)
- [Sprint 55.5: The lifted Linux plan ⏸️](#sprint-555-the-lifted-linux-plan-)
...
Blocked by redesigned Phase 54, its independent validation, and human promotion; every earlier
...
it, and the future human-approved Phase-53 Linux plan must be evaluated inside that distro without amendment.
...
to Phase 53's future approval, and any divergence is a failure rather than a Windows dialect.

**Phase scope:** one cohesive target claim — *a Windows host reaches the same Linux engine Phase 53 must establish,
...
**Depends on:** [Phase 54](phase_54_apple_engine_bringup.md)
...
| `Predecessor` | UNRESOLVED — blocks validation: typed semantic payload and reviewer custody missing; prior prose: Exact external `ImmediatePredecessorApproval` for Phase 54; candidate execution separately refuses an absent, stale, replayed, or locally shaped receipt. |
...
## Sprint 55.1: The firmware and elevation preflight ⏸️

**Status**: Blocked — NOT VALIDATED
**Implementation**: UNRESOLVED — blocks validation: the authored Haskell implementation path has not been established.
**Blocked by**: [Phase 54](phase_54_apple_engine_bringup.md) human approval
...
## Sprint 55.2: Ensuring WSL2 through the vendor installer ⏸️
...
## Sprint 55.3: The reboot verdict and the convergent retry ⏸️
...
## Sprint 55.4: The amoebius-owned distro ⏸️
...
## Sprint 55.5: The lifted Linux plan ⏸️

**Status**: Blocked — NOT VALIDATED
**Implementation**: UNRESOLVED — blocks validation: the authored Haskell implementation path has not been established.
**Blocked by**: Sprint 55.4
**Independent Validation**: UNRESOLVED — blocks validation: no falsifiable positive control, paired specific-reason negative, changed-subject mutant, and residue seam has been established.
**Oracle**: UNRESOLVED — blocks validation: no separate Haskell oracle, independence boundary, and human reviewer have been established.
**Legacy IDs**: UNRESOLVED — blocks validation: typed Haskell legacy bindings have not been reconciled for this sprint.
**Docs to update**: UNRESOLVED — blocks validation: governed doctrine owners have not been established for this sprint.
...
- [Phase 54](phase_54_apple_engine_bringup.md)
