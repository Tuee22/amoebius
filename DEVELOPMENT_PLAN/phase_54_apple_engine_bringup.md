# Phase 54: Apple: Homebrew, Colima, and the native image
...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/README.md, DEVELOPMENT_PLAN/overview.md, DEVELOPMENT_PLAN/phase_55_windows_engine_bringup.md
...
- [Sprints](#sprints)
- [Sprint 54.1: The Homebrew floor is verified, never installed ⏸️](#sprint-541-the-homebrew-floor-is-verified-never-installed-)
- [Sprint 54.2: Colima ensured, and a frame sized from the carve ⏸️](#sprint-542-colima-ensured-and-a-frame-sized-from-the-carve-)
- [Sprint 54.3: The provider follows the workload ⏸️](#sprint-543-the-provider-follows-the-workload-)
- [Sprint 54.4: The ephemeral one-off and the frame that persists ⏸️](#sprint-544-the-ephemeral-one-off-and-the-frame-that-persists-)
- [Sprint 54.5: The lifted step list and the native image ⏸️](#sprint-545-the-lifted-step-list-and-the-native-image-)
...
What makes this phase cheap is that the step list is Phase 52's, lifted into the Colima frame rather than
...
**Depends on:** [Phase 53](phase_53_linux_engine_bringup.md)
...
## Sprint 54.1: The Homebrew floor is verified, never installed ⏸️

**Status**: Blocked — NOT VALIDATED
**Implementation**: UNRESOLVED — blocks validation: the authored Haskell implementation path has not been established.
**Blocked by**: [Phase 53](phase_53_linux_engine_bringup.md) human approval
...
## Sprint 54.2: Colima ensured, and a frame sized from the carve ⏸️
...
## Sprint 54.3: The provider follows the workload ⏸️
...
## Sprint 54.4: The ephemeral one-off and the frame that persists ⏸️
...
## Sprint 54.5: The lifted step list and the native image ⏸️
...
Adopt [`substrate_doctrine.md` §4.1 — Colima and Lima on Apple: the provider follows the workload](../documents/engineering/substrate_doctrine.md#41-colima-and-lima-on-apple-the-provider-follows-the-workload);
run Phase 52's step list inside the Colima frame and build the native image with it.
...
- [Phase 90](phase_90_apple_metal_host_daemon.md)
