...
- [Sprints](#sprints)
- [Sprint 23.1: Deterministic paired-plan projection ✅](#sprint-231-deterministic-paired-plan-projection-)
...
`sha256:f6739fd9fd7f6fd2…`; Phase 23 owns no remaining migration deferral.
...
correctness or a live release. See the Phase-23 ledger.
...
**Depends on:** Phase 22 — the sealed `BoundUiProgram` with complete effect bindings.
...
## Sprint 23.1: Deterministic paired-plan projection ✅
...
- Phases 25 and 26 — consume the paired artifacts independently; neither may recompile or reinterpret source.

## Related Documents

- [Phase 22](phase_22_ui_effect_binding.md) — the required sealed bound program.
