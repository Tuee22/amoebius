# Phase 24: Offline language and paired plans
...
Phase 24 delivers the offline language and paired plans; its design is owned by [browser_offline_runtime_doctrine.md](../documents/engineering/browser_offline_runtime_doctrine.md), and the plan for reaching it is owned here.
...
- [Sprints](#sprints)
- [Sprint 24.1: Compile the offline contract ⏸️](#sprint-241-compile-the-offline-contract-)
...
## Sprint 24.1: Compile the offline contract ⏸️
...
remain `UNVERIFIED` here and belong to Phases 28–63.
