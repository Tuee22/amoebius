# Phase 62: Offline replay and durable receipts
...
Phase 62 delivers the offline replay and durable receipts; its design is owned by [browser_offline_runtime_doctrine.md](../documents/engineering/browser_offline_runtime_doctrine.md), [ui_realtime_coordination_doctrine.md](../documents/engineering/ui_realtime_coordination_doctrine.md), [testing_doctrine.md](../documents/engineering/testing_doctrine.md), and the plan for reaching it is owned here.
...
- [Sprints](#sprints)
- [Sprint 62.1: Gate durable replay across replicas ⏸️](#sprint-621-gate-durable-replay-across-replicas-)
...
payload; offline blob transfer is deferred to Phase 62. Phase 60 structurally admits jitML training starts,
...
scoped command/work-id through Pulsar, Phase-39 receipt lookup, and ready-artifact outcome recovery.
...
## Sprint 62.1: Gate durable replay across replicas ⏸️
