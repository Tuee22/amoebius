...
1. **Phase 0 was reopened and resealed on 2026-08-13.** Its deliverables — the provenance classifier,
...
|---|---|---|---|
| 0 | **Policy-conformant** | Refreshed 2026-08-13. The negative-corpus reopening is closed: repository-layout doctrine §3.6 declares the authored corpora as one set with the rules each seeds, the audit parses that table and narrows a finding only at a declared pairing, and a twelfth rule reports any row that names an unknown rule, a missing path, or a rule it no longer seeds. The attestation refusal bundles moved into their own module so the adapter stays fully scanned, and every read-and-write rule now keys on the source snapshot, so an uncommitted file is no longer invisible | None. Phase 0 is resealed |
...
|---|---|---|---|---|---|
| 0 | Documentation suite (whole DSL) | none | — | ✅ Done — resealed 2026-08-13, attestation `sha256:c5a50398cd0d90eb5d4d6c049abc4e32f8517cbc31b7dd7db532e666cb6b8ec2` | [phase_00](phase_00_documentation_suite.md) |
...
| 25 | Typed bake catalog + multi-arch base image + jit-build resolver + distribution registry | linux-cpu | 3 | 🔄 Active — lowest unsealed phase since Phase 24 sealed on 2026-08-14 | [phase_25](phase_25_base_image_registry.md) |
