...
**Consequence for order of work.** Phases 0 through 7 are ✅ Done and Phase 8 is the open contract. The
...
**Current conclusion — 2026-08-20:** **Phases 0 through 7 are Policy-conformant; no other phase is.**
...
twelve-sided run and Phase 2's fourteen-sided run followed on their reopened contracts the same day. Phases 3
through 7 — **all five inserted calculi** — were built and sealed the same day against contracts that had
never had an implementation, at fourteen, fifteen, fourteen, thirteen and thirteen sides. Those eight rows
below are current results; every other row is an **observed footprint**: a run that happened, against a
...
| 8 | Scoped identity kernel | none | `none` | 1 | 🔄 Active — Phase 7 sealed 2026-08-20, so this contract is the open one | [phase_8](phase_08_scope_index.md) |
