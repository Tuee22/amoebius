...
| 3 | The `pb` host-assertion CLI | none | `none` | 2 | ✅ Done — sealed 2026-08-19; the gate records lane `none` and natural `arm64`; the quality floor is a precondition, the absent → present → present replay mutates nothing on its second pass, and all four mutants redden their own check; attestation `sha256:cb6509951dee1242b594aee67b2bd74c3e0aff648fb9af7d96d4bc7b32bc78eb` | [phase_3](phase_03_host_assert_cli.md) |
| 4 | The host-ensure kernel | none | `none` | 2 | ✅ Done — sealed 2026-08-19; the gate records lane `none` and natural `arm64`; the host modules build under `-Werror` with no default arm over a closed type, all four plans join the authored oracle, the replay mutates nothing on its second pass, and all five mutants redden their own check; attestation `sha256:0c15e7073cd5baf6dfbdf02e9467c4425926989eeb95b9ea6f96ff5b211cb37e` | [phase_4](phase_04_host_ensure_kernel.md) |
