# Phase 86: Offline replay and durable receipts
...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/README.md, DEVELOPMENT_PLAN/overview.md, DEVELOPMENT_PLAN/phase_87_offline_blobs_isolation.md
...
- [Sprints](#sprints)
- [Sprint 86.1: Gate durable replay across replicas ⏸️](#sprint-861-gate-durable-replay-across-replicas-)
...
Blocked by redesigned Phase 85, its independent validation, and human promotion; every earlier
...
payload; offline blob transfer is deferred to Phase 87. Phase 42 structurally admits jitML training starts,
...
**Depends on:** [Phase 85](phase_85_ui_ha_multizone.md)
...
1. The pre-reset Python command is rejected and must not run. The future Haskell Phase-86 supporting suite must run; require the scoped canonical trace green,
