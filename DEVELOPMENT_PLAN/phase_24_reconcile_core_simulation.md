# Phase 24: Reconcile decision core under deterministic simulation
...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/README.md, DEVELOPMENT_PLAN/legacy_tracking_for_deletion.md, DEVELOPMENT_PLAN/overview.md, DEVELOPMENT_PLAN/phase_23_dsl_formal_model.md, DEVELOPMENT_PLAN/system_components.md
...
- [Sprints](#sprints)
- [Sprint 24.1: The decision core, separated 📋](#sprint-241-the-decision-core-separated-)
- [Sprint 24.2: Replay under injected schedules 📋](#sprint-242-replay-under-injected-schedules-)
- [Sprint 24.3: The token and reservation protocols under simulation 📋](#sprint-243-the-token-and-reservation-protocols-under-simulation-)
...
⏸️ Blocked pending Phase-23 revalidation — created 2026-08-17 by the ordering re-baseline recorded in
[`legacy_tracking_for_deletion.md`](legacy_tracking_for_deletion.md).

## Phase Summary

[Phase 22](phase_22_deterministic_sim_substrate.md) builds a deterministic-simulation substrate and gates it
...
the missing subject for the instrument Phase 22 builds.
...
seeded mutant. Phase 25 does not open unless the ledger records Register 2 green with runtime fidelity and
...
## Sprint 24.1: The decision core, separated 📋
...
## Sprint 24.2: Replay under injected schedules 📋
...
Run the core under `IOSim`/`IOSimPOR` against the Phase-22 substrate with partition, redelivery, reorder, and
...
## Sprint 24.3: The token and reservation protocols under simulation 📋
...
[Phase 23](phase_23_dsl_formal_model.md) states formally; agreement between the model and the simulation is
...
against the invariants Phase 23 model-checks.

### Deliverables
- The two protocol batteries and their mutants.
- A reported comparison between each simulated property and its Phase-23 model invariant.
...
- `cluster_lifecycle_doctrine.md` — the reconcile loop gains a decision-core/driver split (Sprint 24.1).
- `deterministic_simulation_doctrine.md` — the substrate gains its first amoebius-owned subject (Sprint 24.2).
- `resource_capacity_doctrine.md` — the two protocols gain a pre-cluster home (Sprint 24.3).

**Cross-references to add:**
- `DEVELOPMENT_PLAN/README.md` Phase Overview links its Phase 24 row to this document.
- The live-band reconciler and scheduler phases cite this phase as where their properties were established.

## Related Documents

- [README.md](README.md) — the live tracker; its Phase 24 row is the source for this phase's objective and gate.
- [development_plan_standards.md](development_plan_standards.md) — the rulebook this document obeys.
- [phase_22_deterministic_sim_substrate.md](phase_22_deterministic_sim_substrate.md) — the substrate this
  phase is the first amoebius-owned subject for.
- [phase_23_dsl_formal_model.md](phase_23_dsl_formal_model.md) — the Register-1 half; the invariants this
