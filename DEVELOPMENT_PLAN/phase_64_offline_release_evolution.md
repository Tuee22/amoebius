# Phase 64: Offline release and schema evolution
...
Phase 64 delivers the offline release and schema evolution; its design is owned by [browser_offline_runtime_doctrine.md](../documents/engineering/browser_offline_runtime_doctrine.md), [release_lifecycle_doctrine.md](../documents/engineering/release_lifecycle_doctrine.md), [generated_artifacts_doctrine.md](../documents/engineering/generated_artifacts_doctrine.md), and the plan for reaching it is owned here.
...
- [Sprints](#sprints)
- [Sprint 64.1: Gate offline-compatible rollout and rollback ⏸️](#sprint-641-gate-offline-compatible-rollout-and-rollback-)
...
## Sprint 64.1: Gate offline-compatible rollout and rollback ⏸️
