# Phase 60: Offline language and paired plans
...
Phase 60 delivers the offline language and paired plans; its design is owned by [browser_offline_runtime_doctrine.md](../documents/engineering/browser_offline_runtime_doctrine.md), and the plan for reaching it is owned here.
...
- [Sprints](#sprints)
- [Sprint 60.1: Compile the offline contract ⏸️](#sprint-601-compile-the-offline-contract-)
...
## Sprint 60.1: Compile the offline contract ⏸️
...
remain `UNVERIFIED` here and belong to Phases 61–64.
