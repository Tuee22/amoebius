# Phase 65: Offline multi-zone continuity
...
Phase 65 delivers the offline multi-zone continuity; its design is owned by [browser_offline_runtime_doctrine.md](../documents/engineering/browser_offline_runtime_doctrine.md), [ui_realtime_coordination_doctrine.md](../documents/engineering/ui_realtime_coordination_doctrine.md), [testing_doctrine.md](../documents/engineering/testing_doctrine.md), and the plan for reaching it is owned here.
...
- [Sprints](#sprints)
- [Sprint 65.1: Run the offline multi-zone campaign ⏸️](#sprint-651-run-the-offline-multi-zone-campaign-)
...
This phase composes the Phase-59 online HA topology with encrypted offline projections, outbox, blobs, release
...
## Sprint 65.1: Run the offline multi-zone campaign ⏸️
