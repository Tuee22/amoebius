# Phase 6: Linux: sudoless Docker and the native image
...
a value by [Phase 5](phase_05_amoebius_image_recipe.md), and the pre-binary command surface belongs to
...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/README.md, DEVELOPMENT_PLAN/phase_07_apple_engine_bringup.md
...
- [Sprints](#sprints)
- [Sprint 6.1: The pristine guest and its recorded preflight 📋](#sprint-61-the-pristine-guest-and-its-recorded-preflight-)
- [Sprint 6.2: The pre-binary leg on a host that carries nothing 📋](#sprint-62-the-pre-binary-leg-on-a-host-that-carries-nothing-)
- [Sprint 6.3: The engine, and sudoless access as three proofs 📋](#sprint-63-the-engine-and-sudoless-access-as-three-proofs-)
- [Sprint 6.4: The native build and the version verdict 📋](#sprint-64-the-native-build-and-the-version-verdict-)
- [Sprint 6.5: The second run that changes nothing 📋](#sprint-65-the-second-run-that-changes-nothing-)
...
**Depends on**: [Phase 5](phase_05_amoebius_image_recipe.md)

**Requires**: `host-floor`

**Gate:** `python3 tools/linux_engine_bringup_gate.py --execute` passes every check named in
[Gate integrity](#gate-integrity), twice in succession against one guest. Phase 7 does not open until it is
green.
...
## Sprint 6.1: The pristine guest and its recorded preflight 📋
...
## Sprint 6.2: The pre-binary leg on a host that carries nothing 📋
...
## Sprint 6.3: The engine, and sudoless access as three proofs 📋
...
## Sprint 6.4: The native build and the version verdict 📋
...
## Sprint 6.5: The second run that changes nothing 📋
...
- [Phase 3](phase_03_host_assert_cli.md)
- [Phase 5](phase_05_amoebius_image_recipe.md)
