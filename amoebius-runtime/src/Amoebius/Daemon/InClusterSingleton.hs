module Amoebius.Daemon.InClusterSingleton
...
observeHostlessProviderTopology engine observed
  | observedSingletonRoles observed /= 1 = Left SingletonRoleCardinality
