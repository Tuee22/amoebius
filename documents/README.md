...
**Supersedes**: N/A
**Referenced by**: README.md, documents/engineering/README.md, documents/illegal_state/illegal_state_catalog.md
...
- **[`illegal_state/`](./illegal_state/illegal_state_catalog.md)** — the illegal-state catalog family: the
