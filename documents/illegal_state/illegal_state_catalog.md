...
**Tier-2** runtime-enforcement residue (Phase 26).
...
`Gate-1-editor`, `Gate-2-decoder`, `Gate-3-astcheck`, `provision-seal`, `rendered-output-golden`, and `live-effect` — each
