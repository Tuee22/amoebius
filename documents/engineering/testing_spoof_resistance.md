...
it. That result is source admission, not runtime evidence. Phase 0 through Phase 50 invoke Haskell directly.
Phase 51 alone places the already source-bounded adapter effects, executable identity, unchanged argv, exec
