...
- [Phase 12](../../DEVELOPMENT_PLAN/phase_12_formal_model_kernel.md) — first formal-model gate using the testing registers
- [Phase 31](../../DEVELOPMENT_PLAN/phase_31_capability_bind.md) — capability-binding gate using derived test surfaces
