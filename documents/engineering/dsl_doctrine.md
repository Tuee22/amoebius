...
The pure Phase-31 binder expands the complete source inventory and produces an unprovisioned
...
The eventual [Phase-31 gate](../../DEVELOPMENT_PLAN/phase_31_capability_bind.md) must establish the first
...
their named Haskell boundary. Phase 31 is **NOT VALIDATED** and cannot establish the infrastructure or
...
`ProvisionedSpec` can cross the Phase-34 deployment-level `renderAll` boundary. Thus a capacity sum is a
