...
- **Composable per the dependency graph.** `renderAll` must map every service/global render source in the
  unique source inventory that Phase 32 will eventually seal. Phase 32 is **NOT VALIDATED**. Ordering and
...
%% register: algebra
  ...
  g1 -->|ready| p2[/"Re-observe and enact phase 12 typed actions"/]:::effect
