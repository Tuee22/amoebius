...
Vault/PKI land in **Phase 18**; amoebic spawning via SSH-key Pulumi with the MinIO backend + Vault-envelope
encryption lands in **Phase 28**; provider-managed clusters (EKS) and dynamic node
