...
The design is planned in Phases 60–64. Status and evidence remain solely in the
...
Phase 60 implements the closed `OnlineOnly | Offline` source choice, bounded queue contracts, initial ML
