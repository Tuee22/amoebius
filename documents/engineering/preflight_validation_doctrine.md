...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/phase_65_live_dsl_deploy.md, documents/engineering/README.md, documents/engineering/diagram_conventions.md, documents/glossary.md
...
the [development plan](../../DEVELOPMENT_PLAN/README.md#generation-2-reset). Where a mechanism runs
...
%% register: algebra
  ...
  dhall-typecheck{"the proof-assistant track gate: a complete SV P is required"}:::decision
...
### 4.5 The the proof-assistant track seal stack and transport
...
each mutation in the proof-assistant track
