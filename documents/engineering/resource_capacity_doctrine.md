...
- **A `ScalingPolicy` grows only a declared worker pool — rke2 `agents` or managed-provider workers; the
  ...
  snapshot admission, join, and enforcement remain an explicitly unassigned Phase-N gate. Phase 47 enacts
...
| Kind bootstrap and enforcement of named engine-process/control-plane storage quotas | [../../DEVELOPMENT_PLAN/phase_24_midwife_bootstrap_kind.md](../../DEVELOPMENT_PLAN/phase_24_midwife_bootstrap_kind.md) |
...
enaction in **Phase 47**. This doc never maintains a competing status ledger; it states the target shape and
