...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/phase_48_gateway_migration_drills.md, documents/engineering/chaos_failover_doctrine.md, documents/engineering/consistency_pacelc_doctrine.md, documents/engineering/gateway_migration_doctrine.md
...
> amoebius runs no cross-cluster geo-replication today, but Phase 47 is exactly this shape, so the doctrine
...
[gateway_migration_model_doctrine.md](./gateway_migration_model_doctrine.md) (Phase 4), which the
...
design-model's safety/liveness properties are *proven for the model at scope 2* in Phase 4 (design-first), and
model↔code correspondence is differentially checked; the runtime fidelity (real physics) and live
cross-cluster-failover-in-a-running-forest remain UNVERIFIED — the Tier-2 Phase-48 obligation, and the single
