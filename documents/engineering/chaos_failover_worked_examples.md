...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/phase_76_gateway_migration_drills.md, documents/engineering/README.md, documents/engineering/chaos_failover_doctrine.md, documents/engineering/consistency_pacelc_doctrine.md, documents/engineering/gateway_migration_doctrine.md
...
> amoebius runs no cross-cluster geo-replication today, but Phase 75 is exactly this shape, so the doctrine
...
[gateway_migration_model_doctrine.md](./gateway_migration_model_doctrine.md) (Phase 18), which the
...
design-model's safety/liveness properties are Phase-18 proof obligations at scope 2 (design-first), and
model↔code correspondence is differentially checked; the runtime fidelity (real physics) and live
cross-cluster-failover-in-a-running-forest remain UNVERIFIED — the Tier-2 Phase-76 obligation, and the single
