...
*Target boundary: the diagram mixes Phase 4/19 obligations with later design intent; none is a current result.*

The bound Phase 4 suite checks a six-state reconcile-protocol model with four safety invariants and one
...
[Phase 75](../../DEVELOPMENT_PLAN/phase_75_gateway_migration_drills.md) implementation adds a standalone pure
...
> **Honesty.** Phase 4 owns only the bounded reconcile-model proof obligation; Phase 75 owns only the pure-core
