...
> named in-scope ([§1](#1-why-this-doctrine-exists-the-inter-cluster-wire-is-an-open-gap)) but is Phase-42 design intent — the disjoint-per-cluster addressing exists, the
...
orientation only: the fabric was promoted from the former later-phase candidate into Phase 41; the old
