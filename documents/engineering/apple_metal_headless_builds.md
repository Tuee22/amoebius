...
> (Phase 41), so every prescriptive statement below is a **target shape**, not a tested amoebius fact. Status
...
headless fixed-Metal-bridge build + the native Apple-Metal host worker land in **Phase 41** (`apple`), whose
gate ([phase_41_apple_metal_host_daemon.md](../../DEVELOPMENT_PLAN/phase_41_apple_metal_host_daemon.md)) brings up
...
- [Phase 41 — Apple-Metal host daemon](../../DEVELOPMENT_PLAN/phase_41_apple_metal_host_daemon.md)
