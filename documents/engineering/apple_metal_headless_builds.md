...
> (Phase 35), so every prescriptive statement below is a **target shape**, not a tested amoebius fact. Status
...
headless fixed-Metal-bridge build + the native Apple-Metal host worker land in **Phase 35** (`apple`), whose
gate ([phase_35_apple_metal_host_daemon.md](../../DEVELOPMENT_PLAN/phase_35_apple_metal_host_daemon.md)) brings up
...
- [Phase 35 — Apple-Metal host daemon](../../DEVELOPMENT_PLAN/phase_35_apple_metal_host_daemon.md)
