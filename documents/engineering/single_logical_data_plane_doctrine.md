...
- **Many data planes, reached by gateway migration.** The remote compute *is* a second cluster, with its
  ...
  [chaos_failover_doctrine.md](./chaos_failover_doctrine.md) and Phases 28–29.
...
| Owned by | **This doc** + [network_fabric_doctrine.md](./network_fabric_doctrine.md) | [chaos_failover_doctrine.md](./chaos_failover_doctrine.md), [gateway_migration_doctrine.md](./gateway_migration_doctrine.md), Phases 28–29 |
...
(Phase 30), and rides the WireGuard fabric promoted from the former later-phase candidate into Phase 27 — but is
...
> unbuilt Phase-35 design, and its loopback-NodePort shape has only a prodbox precedent (evidence, not amoebius
