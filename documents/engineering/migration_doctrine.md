...
**Supersedes**: N/A
**Referenced by**: DEVELOPMENT_PLAN/legacy_tracking_for_deletion.md, documents/engineering/README.md, documents/engineering/gateway_migration_doctrine.md, documents/engineering/generated_artifacts_doctrine.md, documents/engineering/inforcespec_migration_doctrine.md, documents/engineering/monitoring_doctrine.md, documents/engineering/tenancy_doctrine.md, documents/glossary.md, documents/illegal_state/illegal_state_multicluster.md, documents/illegal_state/illegal_state_storage.md, documents/illegal_state/illegal_state_techniques.md
...
| DSL schema evolution | widening (optional field / uninhabited arm) is transparent; narrowing is a Gate-1 rejection the operator resolves by editing the authored value; reinterpretation is inadmissible | Gate-1 typecheck over the committed fixture corpus | no automatic rewrite of an authored `.dhall`; the prior schema is the prior `Release` | `type-foreclosed` (Gate 1) + review residue on reinterpretation | [generated_artifacts §5.1](./generated_artifacts_doctrine.md#51-when-the-authored-schema-changes-under-an-authored-dhall) |
...
- **Sibling-project convergence is a homonym.** The "migration fixtures" and the migration-removal ledger that
  ...
  ([lift_and_compose_doctrine.md §4](./lift_and_compose_doctrine.md#4-sibling-demo-clients-are-migration-inputs-not-the-runtime-model),
