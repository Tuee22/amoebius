...
Former detector, coordinator, and Incus-run reports do not certify the current implementation. The Haskell
coordinator and substrate gates retain their required observations and exclusions in the
