...
It is not the general calculus, it carries no per-transition witness type yet, and the Incus row above is
doctrine rather than delivered code. Status lives only in the [tracker](../../DEVELOPMENT_PLAN/README.md).
