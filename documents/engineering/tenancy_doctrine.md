...
[Phase 6](../../DEVELOPMENT_PLAN/phase_06_extension_admission_attested_scope.md) owns the lexical Register-1 mechanism in
...
amoebius result; only a numerically ordered, qualified gate pass against separately authored expectations may do so.
