...
the cluster's credentials from Vault, not returning them directly from the function.
"""
...
async def save_rke2_credentials(
    ...
    Args:
        ...
        vault_path: e.g. "secret/data/rke2/cluster1"
        creds: The RKE2Credentials object
    """
...
async def load_rke2_credentials(
    ...
    """
    Retrieve the RKE2Credentials from a given Vault path.

    Raises an error if the data is missing or invalid.
    """
