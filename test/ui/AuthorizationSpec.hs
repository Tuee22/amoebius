...
buildFixture root = do
  rows <- loadTable (root </> "test/fixtures/ui_authorization/action_registry.tsv")
...
checkParityErrors root fixture = do
  expectedRows <- loadTable (root </> "test/fixtures/ui_authorization/decode_errors.tsv")
...
checkAuthorizationMatrix root fixture = do
  rows <- loadTable (root </> "test/fixtures/ui_authorization/authorization_matrix.tsv")
...
checkStaleEpochs root fixture = do
  rows <- loadTable (root </> "test/fixtures/ui_authorization/stale_decision_cases.tsv")
