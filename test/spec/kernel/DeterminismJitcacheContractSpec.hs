...
determinismContract = do
  let master = splitMixSeed 0x0123456789abcdef
      ...
      sameA = seededStage "determinism-jitcache-pinned-input-a" seed
      sameB = seededStage "determinism-jitcache-pinned-input-a" seed
      altSeed = seededStage "determinism-jitcache-pinned-input-a" (deriveSplitMixSeed master 1)
      altInput = seededStage "determinism-jitcache-pinned-input-b" seed
