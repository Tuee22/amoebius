...
main=do
 ...
 putStrLn "ui-rollout-reconnect-ui-rollout-reconnect: PASS-SCOPED (watermark-gated A-B-A; stale-plan reload; scoped cursor resume; registration drain; live Gateway/Pulsar/browser UNVERIFIED)"
verifyCustody=do
