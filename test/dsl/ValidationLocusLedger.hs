...
loadCompileCoverage = do
  rows <- rowsOf "tests/oracle/phase6/compile_fail.tsv"
...
emitLedger rows = do
  createDirectoryIfMissing True "gen/dsl/phase6"
  Text.writeFile "gen/dsl/phase6/validation-locus-ledger.tsv" $ Text.unlines
