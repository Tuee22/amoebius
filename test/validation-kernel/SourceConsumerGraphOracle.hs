...
sourceConsumerGraphSelectorRegistryProblems exactCases =
  concat
    [ expectEqual "literal selector registry cardinality" 464 (length sourceConsumerGraphSelectorIntents)
    , expectEqual "literal selector registry unique cardinality" 464 (Set.size selectorSet)
