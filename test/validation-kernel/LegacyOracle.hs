...
canonicalBindings =
  ...
  , ("LTD-VAL-006", "Active", "00", "run-input-closure", "run-input-provenance", "run-input-closure", ["reject-ambient-or-stale-run-input"])
