...
legacySelectorIntents =
  ...
  , ("VALIDATION_LEGACY_RAW_SOURCE_CUSTODY_DROP_MUTANT", "source-custody residue", "canonical legacy wire")
  ...
  , ("VALIDATION_LEGACY_RAW_HUMAN_REVIEW_DROP_MUTANT", "human-review residue", "canonical legacy wire")
  ...
  , ("VALIDATION_LEGACY_INTERNAL_PROJECTION_AUTHORITY_MAPPING_DROP_MUTANT", "Legacy Internal projection authority mapping drop locus", "canonical legacy wire")
  , ("VALIDATION_LEGACY_INTERNAL_PROJECTION_AUTHORITY_MAPPING_KEY_MUTANT", "Legacy Internal projection authority mapping key locus", "canonical legacy wire")
  ...
  , ("VALIDATION_LEGACY_INTERNAL_RAW_ACQUISITION_CODE_MUTANT", "Amoebius.Validation.Legacy.Internal.legacyRawAcquisitionCode refusal code", "canonical legacy wire")
  , ("VALIDATION_LEGACY_INTERNAL_RAW_ACQUISITION_DETAIL_MUTANT", "Amoebius.Validation.Legacy.Internal.legacyRawAcquisitionDetail role-bound refusal detail", "canonical legacy wire")
  , ("VALIDATION_LEGACY_INTERNAL_RAW_ACQUISITION_FINDING_DROP_MUTANT", "Amoebius.Validation.Legacy.Internal.legacyRawAcquisitionFindings mandatory raw-acquisition refusal retention", "canonical legacy wire")
  , ("VALIDATION_LEGACY_INTERNAL_RAW_ACQUISITION_SUBJECT_MUTANT", "Amoebius.Validation.Legacy.Internal.legacyRawAcquisitionSubject role-bound refusal subject", "canonical legacy wire")
  ...
  , ("VALIDATION_LEGACY_MANDATORY_HUMAN_REVIEW_CODE_MUTANT", "Legacy Mandatory human review code locus", "canonical legacy wire")
  , ("VALIDATION_LEGACY_MANDATORY_HUMAN_REVIEW_DETAIL_MUTANT", "Legacy Mandatory human review detail locus", "canonical legacy wire")
  , ("VALIDATION_LEGACY_MANDATORY_HUMAN_REVIEW_SUBJECT_MUTANT", "Legacy Mandatory human review subject locus", "canonical legacy wire")
  ...
  , ("VALIDATION_LEGACY_MANDATORY_SOURCE_CUSTODY_CODE_MUTANT", "Legacy Mandatory source custody code locus", "canonical legacy wire")
  , ("VALIDATION_LEGACY_MANDATORY_SOURCE_CUSTODY_DETAIL_MUTANT", "Legacy Mandatory source custody detail locus", "canonical legacy wire")
  , ("VALIDATION_LEGACY_MANDATORY_SOURCE_CUSTODY_SUBJECT_MUTANT", "Legacy Mandatory source custody subject locus", "canonical legacy wire")
  ...
  , ("VALIDATION_LEGACY_INTERNAL_AUTHORITY_MAPPING_PROJECTION_COMPOSITION_MUTANT", "Legacy Internal authority mapping projection composition locus", "canonical legacy wire")
  ...
  , ("VALIDATION_LEGACY_INTERNAL_RAW_ACQUISITION_FINDING_COMPOSITION_MUTANT", "Legacy Internal RAW acquisition finding composition locus", "canonical legacy wire")
  , ("VALIDATION_LEGACY_INTERNAL_RAW_ACQUISITION_RESULT_NAME_MUTANT", "Legacy Internal RAW acquisition result name locus", "canonical legacy wire")
...
runExactCase candidate =
  pure
    [ exactLabel candidate <> " changed:\nexpected=" <> show (exactExpected candidate)
        <> "\nactual=" <> show actual
    | actual /= exactExpected candidate
    ]
 where
...
aggregateFailureCase label bindings joins =
  resourceCase label "00" bindings joins "00" "25" "9"
    ("aggregate-byte-limit:2715:" <> Text.pack (show actual))
    (literalResource "LEGACY-AGGREGATE-BYTE-LIMIT" "<legacy-input>" 2715 actual)
 where
    ...
    , checkFindings =
        mandatoryFindings commitmentDetail
          ...
          <> [Finding "LEGACY-PHASE-BLOCKED" ("phase-" <> Text.unpack safePhase)
                ("every later phase requires its predecessor's external human approval" <> commitmentDetail)
             | phaseBlocked]
    }
 where
...
-- the package-hidden parser, lifecycle, register, dispatch, and authority
...
mandatoryFindings detail =
  ...
  , Finding "LEGACY-SOURCE-CUSTODY-UNAVAILABLE" "<caller-supplied-legacy-input>"
      ("no authenticated atomic source acquisition is attached" <> detail)
  ...
  , Finding "LEGACY-HUMAN-REVIEW-UNAVAILABLE" "DEVELOPMENT_PLAN/legacy_tracking_for_deletion.md"
      ("reader-facing prose correspondence has not received independent human review" <> detail)
  ]
...
canonicalBindings =
  ...
  , ("LTD-VAL-001", "Active", "00", "validation-protocol", "validation-authority-graph", "validation-protocol", ["reject-non-haskell-validation-authority"])
  , ("LTD-VAL-002", "Active", "00", "phase-contracts", "typed-phase-contract-custody", "phase-contracts", ["reject-unbound-phase-contract"])
  , ("LTD-VAL-003", "Active", "00", "status-evidence", "status-evidence-projection", "status-evidence", ["reject-forged-status-evidence"])
  , ("LTD-VAL-004", "Active", "00", "human-promotion", "promotion-trust-root", "human-promotion", ["reject-automated-promotion"])
  , ("LTD-VAL-005", "Active", "49", "hardware-free-dsl", "hardware-free-dsl-trace", "hardware-free-dsl", ["reject-hardware-before-dsl-promotion"])
