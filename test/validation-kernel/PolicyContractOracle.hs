...
policyContractSelectorIntents =
  ...
  , ( "VALIDATION_POLICY_SERIALIZER_STATUS_PHASE_00_DROP_MUTANT"
    , "serialized policy wire: status phase 0 drop"
    , "canonical policy diagnostic"
    )
...
expectedPolicyResult =
  CheckResult
    ...
    , checkObservations =
        ...
        , Observation "policy.dsl-barrier-source-closure" "all-ltd-src-queries-zero-before-phase-50"
        , Observation "policy.pb-transport" "direct-haskell-through-49;observed-pb-at-50;phase-51-approval-bound-pb-after-50"
...
literalPolicyLines =
  ...
  , "universe.dsl-barrier-source-closure=all-ltd-src-queries-zero-before-phase-50"
  , "universe.prehardware-rule=no-hardware-through-phase-52"
  , "universe.pb-transport-rule=direct-haskell-through-49;observed-pb-at-50;phase-51-approval-bound-pb-after-50"
  ...
  , "status.phase-0=active-not-validated"
  ...
  , "ordering.dsl-barrier-source-closure=all-ltd-src-queries-zero-before-phase-50"
  , "ordering.prehardware=no-hardware-through-phase-52"
  , "ordering.pb-transport=direct-haskell-through-49;observed-pb-at-50;phase-51-approval-bound-pb-after-50"
