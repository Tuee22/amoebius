...
def main():
 nonce="phase55-live-8c19f27a"; listener=socket.socket(); listener.bind(("127.0.0.1",0)); listener.listen(1); port=listener.getsockname()[1]; observed=[]
 def replica_a():
 ...
 with tempfile.TemporaryDirectory(prefix="amoebius-phase55-") as temp:
