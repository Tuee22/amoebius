#!/usr/bin/env python3
"""Prove Phase-25 BuildKit scratch and local-cache ENOSPC boundaries."""
...
def scenario(
    ...
    socket_root = root / f"{name}-socket"
    ...
    builder = f"amoebius-phase25-enospc-{name}"
    container = f"amoebius-phase25-enospc-{name}-buildkitd"
    mounted_cache = False
    try:
