...
FLAGS = (
    "offline-language-plan-drop-queue-bound-mutant",
    "offline-language-plan-omit-server-handler-mutant",
    "offline-language-plan-queue-model-invocation-mutant",
    "offline-language-plan-persist-private-field-mutant",
    "offline-language-plan-browser-redis-constructor-mutant",
)
...
def main():
    ...
    print(
        f"offline-language-plan-gate: PASS ({len(rows)} checks; {derived['ledger_hash']}; "
