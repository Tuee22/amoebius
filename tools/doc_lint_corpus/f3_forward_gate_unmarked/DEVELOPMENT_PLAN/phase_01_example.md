...
**Substrate:** none
**Register:** 1
**Gate:** `cabal test example-spec` is green — the committed golden corpus decodes against an independent oracle and one committed seeded mutant turns it red (Gate; 1.2 V1). The Phase 9 reconciler must be Ready before this gate runs.
