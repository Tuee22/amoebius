...
**Substrate:** none
**Register:** 1
**Gate:** `cabal test example-spec` is green — the committed golden corpus decodes against an independent oracle and one committed seeded mutant turns it red (Gate; 7.2 V1).
