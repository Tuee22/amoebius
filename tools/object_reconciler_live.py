#!/usr/bin/env python3
"""Run the complete live Phase-68 representative reconcile corpus."""
...
# The corpus pulls this from the in-cluster registry, so it is the digest Phase 31
...
def execute() -> dict[str, Any]:
    ...
    try:
        ...
        # longer exists, so the one check that ties the corpus to Phase 31's published
