#!/usr/bin/env python3
"""Run and seal Phase 28's project-contained retained-storage gate."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        if arguments.execute:
            ...
            print("\npredecessor side — verified Phase-27 seal and Phase-25 OCI handoff\n")
            ...
            raise GateFailure("phase-28 needs --execute or a completed --evidence bundle")
        else:
    ...
    return gate.finish(
        ...
        dependencies={
            ...
            "image": "verified Phase-25 OCI export imported into each fresh node",
