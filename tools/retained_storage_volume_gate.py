#!/usr/bin/env python3
"""Seal Sprint 28.2's retained-volume ceiling and explicit rebind."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--image", required=True, help="the Phase-25 digest reference imported into this run's node")
