#!/usr/bin/env python3
"""Acceptance gate for Phase 63's scoped offline release evolution."""
...
ENUMERATION = ROOT / "test/enumeration/phase_63_surfaces.txt"
LEDGER = ROOT / "test/golden/phase_63_ledger.json"
CABAL = "/home/matthewnowak/.ghcup/bin/cabal"
GHC = "/home/matthewnowak/.ghcup/ghc/9.12.4/bin/ghc"
FLAGS = (
    "phase63-clear-state-reload-mutant", "phase63-omit-old-decoder-mutant",
    "phase63-bypass-promotion-check-mutant", "phase63-two-migrations-mutant",
    "phase63-partial-migration-mutant", "phase63-preserve-old-authorization-mutant",
)
...
def derive_ledger():
    ...
    value = {
        "phase": 63, "gate_command": "python3 tools/phase63_gate.py",
...
def main():
    ...
    result = run((sys.executable, "tools/phase63_release_live.py"))
    if result.returncode:
        print(result.stdout)
        return 1
    ...
    print(f"phase63-gate: PASS-SCOPED ({len(rows)} checks; {derived['ledger_hash']}; {receipt['receiptFingerprint']}; platform providers UNVERIFIED)")
    return 0
