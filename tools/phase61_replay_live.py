...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="amoebius-phase61-") as directory:
        root = Path(directory)
    ...
    if not all(assertions.values()):
        raise SystemExit("phase61-live: FAIL " + json.dumps(assertions, sort_keys=True))
    value = {
    ...
    print(
        f"phase61-live: PASS-SCOPED ({value['evidenceDigest']}; "
