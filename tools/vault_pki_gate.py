#!/usr/bin/env python3
"""Run and seal Phase 29's project-contained Vault/PKI acceptance gate."""
...
CONTRACT = "DEVELOPMENT_PLAN/phase_29_vault_pki.md"
...
CHECKS = {
    ...
    "phase28-predecessor-verified": "the exact latest all-pass Phase-28 record is verified",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        print("\npredecessor side — exact Phase-28 seal and Phase-25 OCI handoff\n")
        ...
        if arguments.execute:
            ...
            raise GateFailure("Phase 29 requires --execute or a completed --evidence observation")
