...
def load_sprint3() -> Any:
    path = ROOT / "tools/phase26_sprint26_3_live.py"
    spec = importlib.util.spec_from_file_location("phase26_sprint3_runtime", path)
...
def persistent_volume() -> dict[str, Any]:
    return {
        ...
        "spec": {
            ...
            "hostPath": {"path": "/var/tmp/amoebius-phase26-reservation-child", "type": "DirectoryOrCreate"},
        },
    }
