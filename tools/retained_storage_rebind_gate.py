#!/usr/bin/env python3
"""Seal Sprint 28.3's real cluster delete/recreate retained-byte proof."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--artifact", type=Path, required=True, help="the verified Phase-25 OCI export")
    parser.add_argument("--image-digest", required=True, help="the verified Phase-25 image-index digest")
