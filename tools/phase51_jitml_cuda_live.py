#!/usr/bin/env python3
"""Run the scoped Phase-51 host-CUDA/checkpoint live slice."""
...
def run_live() -> dict[str, Any]:
    ...
    bucket = "p51-" + suffix
    batch = ("phase51-batch|" + challenge).encode()
        ...
        if bucket_created:
            try:
                with phase34.port_forward("platform-system", "service/minio", phase37.MINIO_PORT, 9000):
                    ...
                    phase37.require_s3({204}, phase37.s3_request("DELETE", bucket), "phase51-delete-bucket")
...
def main() -> int:
    ...
    print(
        "phase51-jitml-cuda-live: PASS-SCOPED "
