...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    gate = gate_common.PhaseGate(
        phase=26, contract=CONTRACT, command=GATE_COMMAND,
    ...
    try:
        ...
        if arguments.execute:
            ...
            print(
                "\npredecessor side — verified Phase-25 attestation, ledger, and OCI handoff\n"
            )
    ...
    return gate.finish(
        ...
        dependencies={
            ...
            "registry": "fresh in-cluster distribution from verified Phase-25 handoff",
            **(
                {
                    "phase25Attestation": handoff.attestation,
