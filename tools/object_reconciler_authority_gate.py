#!/usr/bin/env python3
"""Seal the object reconciler's Lease, dispatcher, scoped-SSA, and token boundary."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        rows = [
            ...
            invoke("live-lease-scoped-ssa", (sys.executable, "tools/object_reconciler_authority_live.py", "--output", str(live))),
