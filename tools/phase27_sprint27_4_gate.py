#!/usr/bin/env python3
"""Seal Sprint 27.4 live scheduler binding and bootstrap-to-managed cutover."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        rows = [
            ...
            invoke("bind-before-reservation-CAS-mutant", cabal("scheduler-reservation-spec", "-fphase27-bind-before-reservation-cas-mutant"), expect_failure="Binding requires BindingInFlight CAS"),
